...
class OrderViewController: UIViewController {
    ...
    @IBOutlet weak var oderTable: UITableView!{
        didSet{
            oderTable.register(UINib(nibName: "OrderTableViewCell", bundle: nil), forCellReuseIdentifier: "OrderTableViewCell")
            oderTable.dataSource = self
            oderTable.delegate = self
        }
    }
